...
const FILES = ['liveresults.js', 'liveresults.common.js', 'liveresults.time4o.js'];
...
export function createLegacyViewer(state: Record<string, unknown> = {}): LegacyViewer {
